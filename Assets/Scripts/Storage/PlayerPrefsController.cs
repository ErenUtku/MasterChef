...
namespace Storage
{
    public static class PlayerPrefsController
    {
        ...
        public static void SetLevelChest(int chestIndex) => PlayerPrefs.SetInt("level-chest-index", chestIndex);
        ...
        public static int GetLevelChest() => PlayerPrefs.GetInt("level-chest-index");
        #endregion
    }
}